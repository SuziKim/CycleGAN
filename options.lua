...
local opt_train = {
   ...
   cTextSize = 5,          -- [CityCraft] input city properties size
   tMapSize = 200,         -- [CityCraft] output terrain map size
   ngf = 64,               -- #  of gen filters in first conv layer
   ndf = 64,               -- #  of discrim filters in first conv layer
   input_nc = 1,           -- [CityCraft] #  of input image channels
   output_nc = 2,          -- [CityCraft] #  of output image channels
...
local opt_test = {
  ...
  input_nc = 3,              -- [CityCraft] #  of input image channels
  output_nc = 2,             -- [CityCraft] #  of output image channels
